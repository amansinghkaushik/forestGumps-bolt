...
export const InfoCard3 = (): JSX.Element => {
  ...
  return (
    <section className="w-full h-[100vh] flex justify-center bg-gradient-to-b from-green-50/20 to-white px-5 py-10">
      <div ref={cardRef} className="max-w-[960px] gap-5 h-[calc(100vh-80px)] flex relative transition-all duration-300">
        <div className="w-2/4 gap-5 flex">
          <div className="flex w-1/2 p-2 flex-col">
            <div className="space-y-4">
              ...
              >
                ...
                Trading and
                Retirement of
                <span className="text-forest-green"> Carbon Credits</span>
                with
                Confidence.
              </h2>
            ...
            >
              Our platform makes trading and
              retiring carbon credits simple
              and seamless for everyone. By
              supporting verified projects and
              maintaining transparent
              processes, we ensure that your
              participation in climate action is
          ...
          <div className="flex w-1/2 flex-col justify-end p-2">
            <div className="text-right pb-5 max-w-[225px]">
              ...
              >
                With every credit accounted for
                and traceable, you can
                confidently contribute to
                meaningful environmental
                change, knowing your efforts are
